...
Riva Slider "Lite" is an extremely easy to use slideshow plugin for WordPress. It was built to be lightweight and simple, with absolutely no bloat. It comes with some great features, some of which include:
