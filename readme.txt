...
= 2.0.2 =
* Some CSS adjustments, allowing for easier changes to borders.
* Fixed some jQuery backwards compatibility issues. Plugin should now work as far back as 1.4.2.
