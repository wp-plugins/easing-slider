...
class RivaSliderLite {
    ...
    public function network_activate() {
        ...
        /** Deactivate Easing Slider if it is active */
        if ( is_plugin_active( 'easing-slider/easingslider.php' ) ) {
            deactivate_plugins( plugin_basename( __FILE__ ) );
            wp_die( __( 'Please deactivate Easing Slider before activating Riva Slider "Lite". Both plugins cannot be activated at the same time.', 'rivasliderlite' ) );
            return;
        }
